...
4. Per state: GPR/SMT (informational) + linear/PySR equation (embedded)
...
- `output_phase2_gpr_3000/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + output equations)
- `output_phase2_gpr_3000/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_phase2_gpr_3000/model_comparison.md` (+ .json)
- `output_phase2_gpr_3000/current_insights_report.md` (+ .json)
