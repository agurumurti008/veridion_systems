...
4. Per state: GPR/SMT/PINN/NODE (informational) + degree-2 polynomial equation (embedded)
...
- `output_phase2_2/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + output equations)
- `output_phase2_2/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_phase2_2/model_comparison.md` (+ .json)
- `output_phase2_2/current_insights_report.md` (+ .json)
