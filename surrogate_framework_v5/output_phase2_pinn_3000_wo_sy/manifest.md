...
4. Per state: GPR/SMT/PINN (informational) + linear equation (embedded)
...
- `output_phase2_pinn_3000_wo_sy/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + output equations)
- `output_phase2_pinn_3000_wo_sy/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_phase2_pinn_3000_wo_sy/model_comparison.md` (+ .json)
- `output_phase2_pinn_3000_wo_sy/current_insights_report.md` (+ .json)
