...
- `output_phase2_3/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + output equations)
- `output_phase2_3/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_phase2_3/model_comparison.md` (+ .json)
- `output_phase2_3/current_insights_report.md` (+ .json)
