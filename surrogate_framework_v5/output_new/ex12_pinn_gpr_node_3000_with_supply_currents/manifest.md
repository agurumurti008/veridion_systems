...
4. Per state: PINN/GPR/NODE (informational) + degree-2 polynomial equation (embedded)
...
Equation source: degree-2 polynomial
...
- `output_new/ex12_pinn_gpr_node_3000_with_supply_currents/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + output equations)
- `output_new/ex12_pinn_gpr_node_3000_with_supply_currents/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_new/ex12_pinn_gpr_node_3000_with_supply_currents/model_comparison.md` (+ .json)
- `output_new/ex12_pinn_gpr_node_3000_with_supply_currents/current_insights_report.md` (+ .json)
