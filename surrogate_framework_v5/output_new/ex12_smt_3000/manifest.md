...
4. Per state: SMT (informational) + degree-2 polynomial equation (embedded)
...
**Analog skeleton output-driving equations: EMBEDDED**
  ...
  outputs: ['VDD_1V2', 'VDD_1V2_I']

## Output files

- `output_new/ex12_smt_3000/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + output equations)
- `output_new/ex12_smt_3000/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_new/ex12_smt_3000/model_comparison.md` (+ .json)
- `output_new/ex12_smt_3000/current_insights_report.md` (+ .json)
