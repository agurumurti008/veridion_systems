...
Full report: `output_new/ex17_graybox_update_2_round_3/graybox_fit_report.md` (+ .json)
...
- `output_new/ex17_graybox_update_2_round_3/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + differential output equations)
- `output_new/ex17_graybox_update_2_round_3/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_new/ex17_graybox_update_2_round_3/model_comparison.md` (+ .json)
- `output_new/ex17_graybox_update_2_round_3/graybox_fit_report.md` (+ .json)
- `output_new/ex17_graybox_update_2_round_3/parameter_sensitivity_map.md` (+ .json) — item 4a engineering-insight mechanism
- `output_new/ex17_graybox_update_2_round_3/ldo_analog_core_nn.vams` — fitted analog core (nn)
- `output_new/ex17_graybox_update_2_round_3/ldo_analog_core_ss.vams` — fitted analog core (ss)
- `output_new/ex17_graybox_update_2_round_3/ldo_analog_core_ww.vams` — fitted analog core (ww)
- `output_new/ex17_graybox_update_2_round_3/ldo_top_nn.vams` — top-level wrapper (nn, item 3)
- `output_new/ex17_graybox_update_2_round_3/ldo_top_ss.vams` — top-level wrapper (ss, item 3)
- `output_new/ex17_graybox_update_2_round_3/ldo_top_ww.vams` — top-level wrapper (ww, item 3)
- `output_new/ex17_graybox_update_2_round_3/graybox_process_lut.blut` — process LUT param store
