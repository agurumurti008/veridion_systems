...
Corners fitted: 27
Full report: `output_new/ex17_graybox_integral/graybox_fit_report.md` (+ .json)
...
**Analog skeleton output-driving equations: EMBEDDED**
  ...
  ddt() present: True   idt() present: True

## Output files

- `output_new/ex17_graybox_integral/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + differential output equations)
- `output_new/ex17_graybox_integral/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_new/ex17_graybox_integral/model_comparison.md` (+ .json)
- `output_new/ex17_graybox_integral/graybox_fit_report.md` (+ .json)
