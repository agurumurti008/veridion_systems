...
**Analog skeleton output-driving equations: EMBEDDED**
  ...
  ddt() present: True   idt() present: True   transition() present: True

## Output files

- `output_new/ex14_3000_gpr_pinn_node_sym/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + differential, transition()-smoothed output equations)
- `output_new/ex14_3000_gpr_pinn_node_sym/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_new/ex14_3000_gpr_pinn_node_sym/model_comparison.md` (+ .json)
- `output_new/ex14_3000_gpr_pinn_node_sym/transition_sensitivity.json`
