...
Full report: `output_new/ex17_graybox_update_1/graybox_fit_report.md` (+ .json)
...
- `output_new/ex17_graybox_update_1/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + differential output equations)
- `output_new/ex17_graybox_update_1/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_new/ex17_graybox_update_1/model_comparison.md` (+ .json)
- `output_new/ex17_graybox_update_1/graybox_fit_report.md` (+ .json)
