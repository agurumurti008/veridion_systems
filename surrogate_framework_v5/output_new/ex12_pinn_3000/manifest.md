...
4. Per state: PINN (informational) + degree-2 polynomial equation (embedded)
...
- `output_new/ex12_pinn_3000/ldo_fsm_skeleton.vams` — final Verilog-A (FSM + self-checks + output equations)
- `output_new/ex12_pinn_3000/ldo_fsm_skeleton.sv` — final SystemVerilog control skeleton
- `output_new/ex12_pinn_3000/model_comparison.md` (+ .json)
- `output_new/ex12_pinn_3000/current_insights_report.md` (+ .json)
